...
3. Modify the ./docker-image/locust-tasks/tasks.py file to use your mongoDB connection string. This file is where you configure what the load test actually "does." When you run the load test, it will execute this file.
